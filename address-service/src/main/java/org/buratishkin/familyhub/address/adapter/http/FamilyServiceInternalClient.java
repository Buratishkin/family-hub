...
import org.buratishkin.familyhub.auth.security.config.InternalServiceProperties;
...
public class FamilyServiceInternalClient {
    private final AddressRemoteServiceProperties remoteServiceProperties;
    ...
    public FamilyView findFamilyById(Long familyId) {
        return get("/internal/families/" + familyId, FamilyView.class);
    }

    public boolean familyExists(Long familyId) {
        return Boolean.TRUE.equals(get("/internal/families/" + familyId + "/exists", Boolean.class));
    }
